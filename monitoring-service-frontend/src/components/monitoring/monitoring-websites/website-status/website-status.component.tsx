...
import { StatusTextDown, StatusTextUp, WebsiteStatusContainer, WebsiteStatusRecordContainer } from "./website-status.styles"
  ...
  return (
    <WebsiteStatusContainer>
      <WebsiteStatusRecordContainer>
        ...
        { !websiteMetadata.up && <StatusTextDown>DOWN</StatusTextDown> }
      </WebsiteStatusRecordContainer>
